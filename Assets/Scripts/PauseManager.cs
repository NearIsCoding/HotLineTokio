...
public class PauseManager : MonoBehaviour
{
    ...
    [SerializeField] private string pauseMenuSceneName = "PauseMenu";    // Nombre de la escena del men  de pausa
    [SerializeField] private KeyCode pauseKey = KeyCode.P;               // Tecla para pausar

    private string gameSceneName;    // Guardar  el nombre de la escena del juego
